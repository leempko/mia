...
| --- | ---   | ---      | ---   | --- | --- |
| 1 | Mon 2 Sep | Lecture |  F239a | Introduction to the course | - slides: [html](lecture_slides/introduction/html/index.html) [pdf](lecture_slides/introduction/intro.pdf) <br/> - jupyter notebook [example](lecture_slides/introduction/exampleNotebook.ipynb) |
